...
function TaskHandler() {
	...
	{ "_id" : null, "count" : 9 }
> db.tasks.aggregate([{'$match':{'startDate':{$gt:1465948182381,$lt:1466552982381}}},{$group:{_id:null,count:{$sum:'$totalTime'}}}])
{ "_id" : null, "count" : 51 }
	*/
	this.getWeeklyTotal = function(req, res, next) {

			let endDate = new Date().getTime() + 86400000;
			let startDate = new Date(endDate - 604800000).getTime();
			console.log(endDate);
